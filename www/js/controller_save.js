...
app.controller = (function() {
    ...
    $(document).bind("pagebeforeshow", function(e, data) {
        ...
        $.when(r1).done(function(dbExist) {
            ...
            if(dbExist == 'yes' || $.mobile.activePage.attr('id') == 'vrn-login-page') {
                ...
                if($.mobile.activePage.attr('id') == 'vrn-form-list-page'){
                    controller.showRoadmapItemPosFormListPage(current_params_url['sp_visit_id']);
                }
                // roadmap / questionnaire item
                if($.mobile.activePage.attr('id') == 'vrn-form-item-page'){
                    controller.showRoadmapItemPosFormItemPage(current_params_url['sp_visit_id'], current_params_url['questionnaire_id']);
                }
        ...
        $.when(r1, r2, r3).done(function(messages) {
           ...
           // + '   <span class="bold">'+last_sync.date+'</span>'
            ...
            if(daily_roadmap.id_roadmap != 0) {
                ...
                $('#vrn-lancer').attr("data-url", "?sp_visit_id="+daily_roadmap.pos_list[0].sp_visit__id_visit+"&roadmap_id="+daily_roadmap.pos_list[0].roadmap_id+"&sales_point_id="+daily_roadmap.pos_list[0].id_sales_point);
    ...
    controller.showRoadmapPanel = function() {
       ...
       $("#vrn-roadmap-header").html(controller.getHeader()).trigger('refresh');
       $("[data-role=footer]").html(controller.getFooter('vrn-roadmap-page')).trigger('refresh');
    ...
    controller.showRoadmapItem = function(roadmap_id,action) {
        app.log("controller.showRoadmapItem", 'wip');
        
        if(action == 'create'){
            // header et footer
            $.mobile.navigate( "#vrn-roadmap-item-page" );
            $("#vrn-roadmap-item-header").html(controller.getHeader()).trigger('refresh');
            $("[data-role=footer]").html(controller.getFooter('vrn-roadmap-page')).trigger('refresh');
        ...
        $.when(r1, r2).done(function(roadmap_retour, sp_list) {
            ...
            //                        window.setTimeout(controller.showRoadmapItem(roadmap_id,'refresh'),1000);
    ...
    controller.showCurrentRoadmapItemListPage = function() {
        ...
        $("[data-role=header]").html(controller.getHeader()).trigger('refresh');
        $("[data-role=footer]").html(controller.getFooter('vrn-roadmap-page')).trigger('refresh');
    ...
    controller.showRoadmapItemPosFormListPage = function(sp_visit_id) {
        app.log("controller.showRoadmapItemPosFormListPage", 'wip');

        // header et footer
        $.mobile.navigate( "#vrn-form-list-page" );
        $("#vrn-form-list-header").html(controller.getHeader()).trigger('refresh');
        $("[data-role=footer]").html(controller.getFooter('vrn-roadmap-page')).trigger('refresh');
        ...
        $.when(r1).done(function(roadmap) {
            ...
            $.when(r2,r3,r4).done(function(data_r2,data_r3,data_r4) {
                ...
                for (var i=0;i<questionnaires.length;i++){ 
                    ...
                    if(questionnaires[i].nb_question_mandatory){
                        ...
                        code += '<li class="ui-corner-all" data-icon="arrow-r-white">'
                            +'        <a href="#vrn-form-item-page" data-url="?sp_visit_id='+daily_roadmap.pos_list[0].sp_visit__id_visit+'&questionnaire_id='+questionnaires[i].id_questionnaire+'" class="vrn-form-list-page-lnk">'
                            +'        '+img
                ...
                $('.vrn-form-list-page-lnk').unbind('tap');
                $('.vrn-form-list-page-lnk').bind('tap', controller.getParamUrl);
                ...
                $('#vrn-comment-cloturee-form-valider-button').bind('tap', function(){
                    
                    controller.closeRoadmapVisit();
    ...
    controller.showRoadmapItemPosFormItemPage = function(sp_visit_id, questionnaire_id) {
        app.log("controller.showRoadmapItemPosFormItemPage", 'wip');
        
        // header et footer
        $.mobile.navigate( "#vrn-form-item-page" );
        $("#vrn-form-item-header").html(controller.getHeader()).trigger('refresh');
        $("[data-role=footer]").html(controller.getFooter('vrn-roadmap-page')).trigger('refresh');
        $("#vrn-form-item-page").trigger('refresh');
    ...
    controller.showRoadmapItemPosFormItemSave = function(event) {
        ...
        $.when(r1, r2).done(function(data_r1) {
            ...
            $.mobile.changePage("questionnaire.html", {
                transition:"slide",
                changeHash:true,
                reverse:true
             });
    ...
    controller.showStatsPanel = function() {
       app.log("controller.showStatsPanel", 'wip');
        ...
        $("#vrn-stats-header").html(controller.getHeader()).trigger('refresh');
        $("[data-role=footer]").html(controller.getFooter('vrn-stats-page')).trigger('refresh');
    ...
    controller.showParamsPanel = function() {
       app.log("controller.showParamsPanel", 'wip');
        ...
        $("#vrn-params-header").html(controller.getHeader()).trigger('refresh');
        $("[data-role=footer]").html(controller.getFooter('vrn-params-page')).trigger('refresh');
    ...
    controller.showParamsForm = function() {
        app.log("controller.showParamsPanel", 'wip');
        // header et footer
        $("#vrn-params-edit-header").html(controller.getHeader()).trigger('refresh');
        $("[data-role=footer]").html(controller.getFooter('vrn-params-page')).trigger('refresh');
    ...
    controller.getHeader = function() {
        ...
        return header;connexion_timestamp
    };
    ...
    controller.getFooter = function(pageId) {
        ...
        if (pageId == "vrn-home-page") {
            ...
            footer += '  <li class="vrn-footer-navbar-li"><a href="homepage.html" id="vrn-taskboard" class="btn- ui-state-persist" data-transition="slide"><span class="vrn-footer-navbar-btn-inner"><div class="footer-icon-task">&nbsp;</div><span class="vrn-footer-navbar-btn-text">Taskboard</span></span></a></li>' 
        }
        if (pageId == "vrn-inform-page") {
            ...
            footer += '  <li class="vrn-footer-navbar-li"><a href="inform.html" id="vrn-watchword" class="btn- ui-state-persist" rel="external" data-ajax="false" data-transition="slide"><span class="vrn-footer-navbar-btn-inner"><div class="footer-icon-inform">&nbsp;</div><span class="vrn-footer-navbar-btn-text">Info</span></span></a></li>' 
        }
        if (pageId == "vrn-roadmap-page") {
            ...
            footer += '  <li class="vrn-footer-navbar-li"><a href="roadmap.html" id="vrn-roadmap" class="btn- ui-state-persist" rel="external" data-ajax="false" data-transition="slide"><span class="vrn-footer-navbar-btn-inner"><div class="footer-icon-road">&nbsp;</div><span class="vrn-footer-navbar-btn-text">Roadmap</span></span></a></li>' 
        }
        if (pageId == "vrn-pos-page") {
            ...
            footer += '  <li class="vrn-footer-navbar-li"><a href="pos.html" id="vrn-pos" class="btn- ui-state-persist" rel="external" data-ajax="false" data-transition="slide"><span class="vrn-footer-navbar-btn-inner"><div class="footer-icon-pos">&nbsp;</div><span class="vrn-footer-navbar-btn-text">POS</span></span></a></li>' 
        }
        if (pageId == "vrn-stats-page") {
            ...
            footer += '  <li class="vrn-footer-navbar-li"><a href="stats.html" id="vrn-stats" class="btn- ui-state-persist" rel="external" data-ajax="false" data-transition="slide"><span class="vrn-footer-navbar-btn-inner"><div class="footer-icon-stats">&nbsp;</div><span class="vrn-footer-navbar-btn-text">Stats</span></span></a></li>' 
        }
        if (pageId == "vrn-params-page") {
            ...
            footer += '  <li class="vrn-footer-navbar-li"><a href="params.html" id="vrn-params" class="btn- ui-state-persist" rel="external" data-ajax="false" data-transition="slide"><span class="vrn-footer-navbar-btn-inner"><div class="footer-icon-params">&nbsp;</div><span class="vrn-footer-navbar-btn-text">Param</span></span></a></li>' 
        }
        footer += '</ul>'; 
        footer += '</div>';
