...
app.repository = (function() {
    ...
    repository.addPos = function(param) {
        app.log("repository.addPos");
        var op_deferred = $.Deferred();

        var rsql = "INSERT INTO sales_point ( name, street, postal_code, city, contact_name, email, phone_number, type_id, user_id ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $.when(requestToDB(rsql,param)).done(function(results) {
